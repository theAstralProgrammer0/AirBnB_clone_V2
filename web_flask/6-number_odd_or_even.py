...
def number_temp(n):
    """This is the number template endpoint function"""
    return render_template('5-number.html', num=str(n))


@app.route('/number_odd_or_even/<int:n>', strict_slashes=False)
def odd_or_even(n):
    if n % 2 == 0:
        return render_template('6-number_odd_or_even.html', num=str(n), par='even')
    else:
        return render_template('6-number_odd_or_even.html', num=str(n), par='odd')
